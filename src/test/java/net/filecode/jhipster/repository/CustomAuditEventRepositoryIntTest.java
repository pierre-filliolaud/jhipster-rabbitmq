package net.filecode.jhipster.repository;

import net.filecode.jhipster.JhipsterApp;
import net.filecode.jhipster.config.Constants;
import net.filecode.jhipster.config.audit.AuditEventConverter;
import net.filecode.jhipster.domain.PersistentAuditEvent;
...
import static net.filecode.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
