package net.filecode.jhipster.web.rest;

import net.filecode.jhipster.config.Constants;
import net.filecode.jhipster.JhipsterApp;
import net.filecode.jhipster.domain.Authority;
import net.filecode.jhipster.domain.User;
import net.filecode.jhipster.repository.AuthorityRepository;
import net.filecode.jhipster.repository.UserRepository;
import net.filecode.jhipster.security.AuthoritiesConstants;
import net.filecode.jhipster.service.MailService;
import net.filecode.jhipster.service.dto.UserDTO;
import net.filecode.jhipster.web.rest.errors.ExceptionTranslator;
import net.filecode.jhipster.web.rest.vm.KeyAndPasswordVM;
import net.filecode.jhipster.web.rest.vm.ManagedUserVM;
import net.filecode.jhipster.service.UserService;
